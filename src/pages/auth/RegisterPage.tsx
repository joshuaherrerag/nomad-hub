...
export default function RegisterPage() {
  const { user, isLoading: authLoading, signUp, signInWithGoogle } = useAuth();
    ...
    <AuthLayout>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        <div>
          ...
          <Input id="fullName" placeholder="Tu nombre" {...register("fullName")} className="mt-1 rounded-xl" />
        ...
        <div>
          ...
          <Input id="password" type="password" placeholder="••••••" {...register("password")} className="mt-1 rounded-xl" />
